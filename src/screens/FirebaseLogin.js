...
const FirebaseLogin = ({navigation,route}) => {
  ...
  const [emailFlowFlag, setEmailFlowFlag] = useState(false);
  ...
  const handleLoginWithMobile = async () => {
    ...
    if (mobileNumber != null && mobileNumber) {
      ...
      const mobile = await AsyncStorage.getItem('mobileNumberWithCode');
      console.log('mobile no with code is in login' + mobile);
      // sendOtp();
    } 
  ...
  return (
    <View style={{flex: 1,backgroundColor:"#ffff"}}>
      ...
      style={{
        ...
        color:"grey",
        fontWeight:"500",
        marginRight:"5%"}}>forgot Password ?</Text>
      </TouchableOpacity>
      <View
        style={{
          flex: 0.12,
      ...
      <View
        ...
        <TouchableOpacity
          ...
          onPress={()=>{setEmailFlowFlag(!emailFlowFlag)}}
          style={{
            width: '90%',
            height: '95%',
